...
-- AlterTable
ALTER TABLE `products` ADD COLUMN `height` DOUBLE NOT NULL DEFAULT 5,
    ADD COLUMN `length` DOUBLE NOT NULL DEFAULT 5,
    ADD COLUMN `weight` DOUBLE NOT NULL DEFAULT 5,
    ADD COLUMN `width` DOUBLE NOT NULL DEFAULT 5;
