/*
  ...
  - You are about to drop the column `nfe` on the `products` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `orders` ADD COLUMN `nfe` TEXT NULL;

-- AlterTable
ALTER TABLE `products` DROP COLUMN `nfe`;
